			 ...
			 @touchstart="swipe.touchstart" @touchmove="swipe.touchmove" @touchend="swipe.touchend" @change="change">
				...
				<view ref="selector-button-hock" class="uni-swipe_button-group selector-query-hock move-hock">
		          ...
		          fontSize: item.style && item.style.fontSize ? item.style.fontSize : '16px'
					 ...
					 class="uni-swipe_button button-hock" @touchstart.prevent="appTouchStart" @touchend.prevent="appTouchEnd($event,index,item)"><text class="uni-swipe_button-text" :style="{color: item.style && item.style.color ? item.style.color : '#FFFFFF',}">{{ item.text }}</text></view>
				</view>
			</view>
		</view>
		<!-- #endif -->
